...
public class DetalleAsignaturaCuadFragment extends Fragment implements DatePickerDialog.OnDateSetListener, ClickListener{
    ...
    private AlumnoClaseCuadAdapter adaptador;
    ...
    public void onActivityCreated(Bundle state) {
        ...
        this.recyclerViewDetalleAsignatura.addItemDecoration(new HorizontalDividerItemDecoration.Builder(getContext())
                .color(Color.WHITE)
                .build());
        this.recyclerViewDetalleAsignatura.addItemDecoration(new VerticalDividerItemDecoration.Builder(getContext())
                .color(Color.WHITE)
                .build());
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            DetalleAsignaturaCuadFragment.this.refresh();
        }
    }
