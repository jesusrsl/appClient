...
public class AlumnoClaseCuadAdapter extends SelectableAdapter<AlumnoClaseCuadAdapter.ViewHolder>{
    ...
    public AlumnoClaseCuadAdapter(Context contexto, ArrayList<AlumnoClase> alumnoClaseArrayList, int idAsignatura, long fecha, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflador.inflate(R.layout.layout_alumno_clase_cuad, parent, false);
